...
//    List<List<LogEntry>> sixListLog = ReadFileService2.loadLogs();
...
//          for (List<LogEntry> oneListLog : sixListLog) {
//            executorService.execute(
//                () -> {
//                  for (LogEntry log : oneListLog) {
...
//            for (List<LogEntry> oneListLogHehe : sixListLog){
//                result.addAll(oneListLogHehe);
//            }
//          }
...
//          File inputFile = new File(ReadFileService2.getFilePath());
